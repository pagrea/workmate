...
<div class="col-md-9 col-lg-12 col-sm-12 pull-left" style="background: white;">
  ...
  <a class="pull-left btn btn-primary btn-sm" href="/Exporthodleavehistory">ExportToExcel</a>
  <form action="/hodleavehistory" method="get">
  <H3 align="center"><b>HODs Leave Hstory</b></H3>
    {{ csrf_field() }}
