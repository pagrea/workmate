...
<h3 align="center">Fill Staff Addresses </h3>
<!-- Example row of columns -->
<div class="row col-sm-12 col-md-12 col-lg-12" style="background:white; margin: 10px">
            <form action="/storestaffaddresses" method="post">
                {!! csrf_field() !!}
