            ...
            <form action="{{route('user.update',[$User->id])}}" method="post">
                ...
                <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                            <select id="Gender" required disabled name="Gender" class="form-control @error('Gender') is-invalid @enderror"/>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="DateOfEmployment" 
                                       ...
                                       disabled name="DateOfEmployment" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="DateOfLastPromotion" 
                                       ...
                                       disabled  name="DateOfLastPromotion" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                            <select id="MaritalStatus" required disabled name="MaritalStatus" class="form-control @error('MaritalStatus') is-invalid @enderror"/>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="BirthCertificateNum" 
                                       ...
                                       disabled  name="BirthCertificateNum" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                            <select id="CurrentStatus" required disabled name="CurrentStatus" class="form-control @error('CurrentStatus') is-invalid @enderror"/>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                            <select id="Department" required disabled name="Department" class="form-control @error('Department') is-invalid @enderror"/>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                            <select id="AbsorbedInNIMR" required disabled name="AbsorbedInNIMR" class="form-control @error('AbsorbedInNIMR') is-invalid @enderror"/>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="EmegencyContantPerson" 
                                       ...
                                       disabled  name="EmegencyContantPerson" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="EmegencyContactNumber" 
                                       ...
                                       disabled name="EmegencyContactNumber" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="StaffCurrentAddress" 
                                       ...
                                       disabled  name="StaffCurrentAddress" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="StaffHomeAddress" 
                                       ...
                                       disabled  name="StaffHomeAddress" 
